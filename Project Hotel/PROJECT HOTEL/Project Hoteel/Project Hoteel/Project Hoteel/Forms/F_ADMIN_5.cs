...
namespace Project_Hoteel
{
    public partial class F_ADMIN_5 : Form
    {
        ...
        private void b_menu_5_Click(object sender, EventArgs e)
        {
            timer_menu.Start();
        }
        ...
        private void timer_menu_Tick(object sender, EventArgs e)
        {
            if (ExpandMenu == true)
            {
                ...
                b_menu_5.BackgroundImage = Properties.Resources.menu;
            ...
            {
                PB_list_bg_5.Width += 5;
                b_menu_5.BackgroundImage = Properties.Resources.menu_blue;
