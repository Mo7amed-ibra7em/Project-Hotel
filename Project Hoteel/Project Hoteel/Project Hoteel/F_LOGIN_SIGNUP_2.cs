...
namespace Project_Hoteel
{
    public partial class F_LOGIN_SIGNUP_2 : Form
    {
        ...
        private void b_login_2_Click_1(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    sqlcmd.CommandText = "select username, password from SECURITY_LOGIN";
            //    sqlconn.Open();
            //    dread = sqlcmd.ExecuteReader();
            //    while (dread.Read())
            //    {
            //        username = dread["username"].ToString();
            //        password = Convert.ToInt32(dread["password"]);   
            //    }
            //}
            //catch (Exception ex)
            //{
            ...
            ////if (t_email_2.Text == "UserName" && t_password_2.Text == "Password")
            ////{
            ////    L_2.Text = "!... ادخل معلوماتك";
            ////    t_email_2.Text = "";
            ////    t_password_2.Text = "";
            ////}
            ////else if (t_email_2.Text == "" && t_password_2.Text == "")
            ////{
            ////    L_2.Text = "!... ادخل معلوماتك";
            ////}
            ////else if (t_email_2.Text != "" && t_password_2.Text == "")
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            if (Login_emp == true || Login_manager == true)
            {
                ...
                label1.Text = Convert.ToString(ProgressBar1.Value /5) + " %";
