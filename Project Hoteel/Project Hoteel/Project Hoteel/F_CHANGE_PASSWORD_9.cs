...
namespace Project_Hoteel
{
    public partial class F_CHANGE_PASSWORD_9 : Form
    {
        ...
        private void b_change_password_9_Click(object sender, EventArgs e)
        {
            ...
            if (t_password_old_9.Text == "" && t_password_new_9.Text == "" && t_user_old_9.Text == "")
            {
                L_9.Text = "!... ادخل بياناتك";
            }
            if (t_password_old_9.Text == Convert.ToString(f_2.password) && t_user_old_9.Text == Convert.ToString(f_2.username) &&t_password_new_9.Text == "")
            {
            ...
            if (t_password_old_9.Text == Convert.ToString(f_2.password) && t_user_old_9.Text != Convert.ToString(f_2.username) && t_password_old_9.Text != "" || t_password_old_9.Text != Convert.ToString(f_2.password) && t_user_old_9.Text == Convert.ToString(f_2.username) && t_password_old_9.Text != "")
            {
                L_9.Text = "!... اسم المستحدم أو كلمة المرور خطأ";
                t_password_old_9.Text = "";
                t_user_old_9.Text = "";
                t_password_new_9.Text = "";

            }
            if (t_password_old_9.Text == Convert.ToString(f_2.password) && t_user_old_9.Text == Convert.ToString(f_2.username))
            {
                if (t_password_new_9.Text != "")
                {
                    ...
                    try
                    {
                        ...
                        sqlcmd1.CommandText = "update Security_Login set password = '"+t_password_new_9.Text+"' where username = '"+t_user_old_9.Text+"'";
                        sqlconn1.Open();
        ...
        private void F_CHANGE_PASSWORD_9_Load(object sender, EventArgs e)
        {
